...
CUDA_VISIBLE_DEVICES=0 python render/render_jsbsim.py \
    ...
    --seed ${seed} --n-training-threads 1 --n-rollout-threads 4 --cuda --log-interval 1 --save-interval 1 \
    ...
    --user-name "jgkim2020" --use-wandb --wandb-name "thu_jsbsim" \
    --model-dir './results/MultipleCombat/2v2/NoWeapon/HierarchySelfplay/mappo/v1/wandb/latest-run/files'